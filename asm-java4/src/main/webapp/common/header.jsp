				...
				<c:choose>
					<c:when test="${not empty sessionScope.currentUser}"> 
						<li class="nav-item"><a class="nav-link nav-link-1 active"
							aria-current="page" href="index">Welcome, ${sessionScope.currentUser}</a></li>
					...
					<c:otherwise>
						...
						<li class="nav-item"><a class="nav-link nav-link-4"
							href="forgotPassword">Forget Password</a></li>
					</c:otherwise>
				</c:choose>
			</ul>
		</div>
...
<div class="tm-hero d-flex justify-content-center align-items-center"
	data-parallax="scroll" data-image-src="<c:url value='/template/user/img/hero.jpg'/>"
